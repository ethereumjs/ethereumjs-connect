...
describe("connect", function () {
  ...
  //                 var connector = require("../");
  //                 var options = element;
  //                 options.contracts = customContracts;
  ...
  //                 assert.strictEqual(conn.ipc, element.ipc);
  //                 assert.isString(connector.coinbase);
  //                 assert.deepEqual(connector.contracts, customContracts);
  //                 assert.deepEqual(connector.initialContracts, customContracts);
  //                 assert.deepEqual(connector.customContracts, customContracts);
  //                 next();
  //             }
  //         );
  //         it.each(connectOptions,
  ...
  it("networkID = 0, 1, 2, 3, 7, or 10101", function () {
    delete require.cache[require.resolve("../")];
    var connector = require("../");
    connector.connect();
    assert.include(["0", "1", "2", "3", "7", "10101"], connector.networkID);
  });
